---
description: "Non-destructive consistency check of the active Relic spec and shared artifacts"
allowed-tools: "Bash(relic *)"
---

<!-- GENERATED from templates/prompts/analyse.md by scripts/build-plugin.ts — do not edit. -->
