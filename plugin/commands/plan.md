---
description: "Create the implementation plan for the active Relic spec (intersection discovery point)"
allowed-tools: "Bash(relic *)"
---

<!-- GENERATED from templates/prompts/plan.md by scripts/build-plugin.ts — do not edit. -->
