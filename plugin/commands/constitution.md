---
description: "Extract project coding principles and standards into the Relic constitution"
allowed-tools: "Bash(relic *)"
---

<!-- GENERATED from templates/prompts/constitution.md by scripts/build-plugin.ts — do not edit. -->
