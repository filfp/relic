---
description: "Generate the atomic task list from the active Relic spec's plan"
allowed-tools: "Bash(relic *)"
---

<!-- GENERATED from templates/prompts/tasks.md by scripts/build-plugin.ts — do not edit. -->
