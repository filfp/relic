---
description: "Apply the active Relic fix document's proposed changes and close the fix"
allowed-tools: "Bash(relic *)"
---

<!-- GENERATED from templates/prompts/solve.md by scripts/build-plugin.ts — do not edit. -->
