---
description: "Create a new Relic spec from a feature description, PRD, or user story"
allowed-tools: "Bash(relic *)"
---

<!-- GENERATED from templates/prompts/specify.md by scripts/build-plugin.ts — do not edit. -->
