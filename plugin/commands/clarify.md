---
description: "Append details, change contracts, or add behaviours to an existing Relic spec"
allowed-tools: "Bash(relic *)"
---

<!-- GENERATED from templates/prompts/clarify.md by scripts/build-plugin.ts — do not edit. -->
