---
description: "Bootstrap the Relic knowledge layer from an existing codebase (run once on adoption)"
allowed-tools: "Bash(relic *)"
---

<!-- GENERATED from templates/prompts/scan.md by scripts/build-plugin.ts — do not edit. -->
